        ...
        <Sheet open={sheetOpen} onOpenChange={setSheetOpen}>
            <SheetContent className="flex flex-col sm:max-w-lg">
                    ...
                    {!cartQuery.isPending && !cartQuery.data?.lineItems?.length && (
                        <div className="flex grow items-center justify-center text-center">
                            <div className="space-y-1.5">
                                <p className="text-lg font-semibold">Il tuo carrello è vuoto</p>
                                <Link
                                    href="/shop"
                ...
                <div className="flex items-center justify-between gap-5">
                    ...
                    <p className="text-sm">Importo totale:</p>
                    <p className="font-bold">
                        {/* @ts-expect-error Il tipo di subtotal potrebbe non essere definito in alcuni casi */}
                        {cartQuery.data?.subtotal?.formattedConvertedAmount}
                    </p>
                    <p className="text-xs text-muted-foreground">
                        Costi di spedizione e tasse calcolati al momento della fatturazione
                    </p>
                    </div>
                    <CheckoutButton
                    size="lg"
