...
function PriceFilter({
    ...
    return (
        <div className="space-y-3">
        <div className="font-bold">Fascia di prezzo</div>
...
function SortFilter({ sort, updateSort }: SortFilterProps) {
    return (
        ...
        <SelectTrigger className="w-fit gap-2 text-start">
            <span>
            Ordina per: <SelectValue />
            </span>
        </SelectTrigger>
        <SelectContent>
            <SelectItem value="last_updated">Novità</SelectItem>
            <SelectItem value="price_asc">Prezzo (dal più basso al più alto)</SelectItem>
            <SelectItem value="price_desc">Prezzo (dal più alto al più basso)</SelectItem>
        </SelectContent>
        </Select>
    );
}