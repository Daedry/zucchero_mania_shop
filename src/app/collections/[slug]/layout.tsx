...
// Il layout viene dichiarato come async
export default async function Layout({
  children,
  params,
}: {
  children: React.ReactNode;
  params: { slug: string }; // Assumiamo che slug esista sempre in una route dinamica
}) {
  if (!params.slug) notFound();

  // Eseguiamo il fetching dei dati direttamente nel layout
