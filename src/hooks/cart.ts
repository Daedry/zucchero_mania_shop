...
export function useAddItemToCart() {
  ...
  return useMutation({
    ...
    onSuccess(data) {
      toast({ description: "Aggiunto al carrello" });
    ...
    onError(error) {
      ...
      toast({
        variant: "destructive",
        description: "Impossibile aggiungere l'articolo al carrello. Per favore, riprova.",
      });
    },
  });
}
...
export function useUpdateCartItemQuantity() {
  ...
  return useMutation({
    ...
    onError(error, variables, context) {
      ...
      toast({
        variant: "destructive",
        description: "Impossibile aggiornare il numero di articoli nel carrello. Per favore, riprova.",
      });
    },
    onSettled() {
...
export function useRemoveCartItem() {
  ...
  return useMutation({
    ...
    onError(error, variables, context) {
      ...
      toast({
        variant: "destructive",
        description: "Impossibile rimuovere l'articolo dal carrello. Per favore, riprova.",
      });
    },
    onSettled() {
      queryClient.invalidateQueries({ queryKey });
